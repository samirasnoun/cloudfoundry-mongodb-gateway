...
node.set['cloudfoundry_mongodb_service']['searched_data']['cloud_controller']['api_uri'] = cc_node['ipaddress'] + ":" + cc_node['cloudfoundry_cloud_controller']['server']['external_port'].to_s

 # + ":" + cc_node['cloudfoundry_cloud_controller']['server']['external_port'] 
...
include_recipe "cloudfoundry-mongodb-gateway::gateway"
